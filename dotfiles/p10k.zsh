# Generated by Powerlevel10k configuration wizard on 2024-05-19 at 21:44 CEST.
...
# angled separators, sharp heads, round tails, 2 lines, dotted, right frame, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    os_cloud                # show the cloud I'm connected to
  )
  ...
  function prompt_example() {
   ...
   # Show the Cloud I'm connected to in red at the right
   #
   function prompt_os_cloud() {
     if [[ -n $MY_CLOUD ]]; then
       p10k segment -f 196  -i '☁️ ' -t "${MY_CLOUD//\%/%%}"
     fi
  }
