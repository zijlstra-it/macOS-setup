...
# System Preferences > Keyboard >
defaults write NSGlobalDomain InitialKeyRepeat -int 15 # 25 was previously in vindication

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

# System Preferences > Trackpad > Tap to click (false)
...
defaults write NSGlobalDomain KeyRepeat -int 2 # 1
defaults write NSGlobalDomain InitialKeyRepeat -int 15 # 10

# Set language and text formats
# Note: if you’re in the US, replace `EUR` with `USD`, `Centimeters` with
# `Inches`, `en_GB` with `en_US`, and `true` with `false`.
defaults write NSGlobalDomain AppleLanguages -array "en" "es"
defaults write NSGlobalDomain AppleLocale -string "en_ES@currency=USD"
...
# Spring loading is when hovering a file over a folder and the folder opens
...
# ALT + Bottom left screen corner → Put Display to Sleep
